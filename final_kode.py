...
print("\n==============================================================")
print("|                                                            |")
print("|             ^_^ APLIKASI PERPUSTAKAAN SIMMY ^_^            |")
print("|                                                            |")
print("==============================================================")
...
while True:
    try:
        ...
        if not username.isalpha():
            raise ValueError("Nama hanya boleh berisi huruf. Silakan masukkan nama yang valid.")
    
        # Jika validasi berhasil, keluar dari loop
        print(f"\nSelamat Datang di aplikasi Menu Perpustakaan, {username} ^_^.")
        tunggu_enter()
        break
...
def tampilkan_buku():
    ...
    for index, value in df_buku.iterrows():
        print(f"{index} \t{value['Kode Buku']:<10}  \t{value['Penulis']:<35}{value['Judul Buku']:<35}{value['Tahun Terbit']:<15}\t\t{value['Stok']:<5}")
...
def pinjam_buku(username):
    ...
    print(f"\nHalo, {username}.")
    no_buku = (str(input("==> Masukkan Kode Buku yang ingin dipinjam : "))) # input untuk memasukkan kode buku yg ingin dipinjem
...
def balikin_buku(username):
    ...
    if no_buku in buku_dipinjam[username]:
        ...
        print("Kode buku tidak valid, anda tidak meminjam buku ini.")
